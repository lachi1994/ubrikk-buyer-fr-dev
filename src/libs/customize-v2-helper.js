...
export function initCenteringGuidelines(canvas) {
	...
	for (
		var j = canvasHeightCenter - centerLineMargin, lens = canvasHeightCenter + centerLineMargin;
		j <= lens;
		j++
	) {
	...
	//These functions are responsible for drawing the vertical and horizontal alignment lines
	...
	//This code is responsible for showing the vertical and horizontal alignment lines
